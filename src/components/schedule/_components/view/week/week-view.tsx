...
export default function WeeklyView({
  ...
  const [ colWidth, setColWidth ] = useState<number[]>(Array.from({ length: 7 }).fill(1)) // Equal width columns by default
  ...
  useEffect(() => {
    setColWidth(Array.from({ length: 7 }).fill(1))
  }, [ currentDate ])
                    ...
                    <div className="text-center p-4">
                      ...
                      <div
                        ...
                        onClick={e => {
                          ...
                          setOpen(<CustomModal title={`${getters.getDayName(day.getDay())} ${day.getDate()}, ${selectedDay.getFullYear()}`}>
                                      ...
                                      <div className="relative">
                                        ...
                                        {dayEvents.map(event => {
                                          ...
                                          for (const timeGroup of timeGroups) {
                                            const groupIndex = timeGroup.findIndex(e => e.id === event.id)
                                            if (groupIndex !== -1) {
                                              eventsInSamePeriod = timeGroup.length
                        ...
                        >
                          <Badge
                            ...
                            onClick={e => {
                              ...
                              setOpen(<CustomModal title={`Events for ${daysOfWeek[dayIndex].toDateString()}`}>
